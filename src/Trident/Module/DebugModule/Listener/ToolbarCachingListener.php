...
use Trident\Module\DebugModule\Toolbar\Extension\TridentCachingExtension;

/**
 * Debug Toolbar Caching Listener
 *
 * @author Elliot Wright <elliot@elliotwright.co>
 */
class ToolbarCachingListener
{
    private $extension;
    private $stack;
     ...
     * @param TridentCachingExtension $extension
     */
    public function __construct(DebugStack $stack, TridentCachingExtension $extension)
    {
